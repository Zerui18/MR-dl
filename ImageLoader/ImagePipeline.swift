...
public /* final */ class ImagePipeline: ImageTaskDelegate {
    ...
    public static var sharedMRI: ImagePipeline!
    ...
    public struct Configuration {
        ...
        /// Data loading queue. Default maximum concurrent task count is 8.
        public var dataLoadingQueue = OperationQueue()

        /// Data cache used by the pipeline.
        public var dataCache: DataCaching?

        /// Data caching queue. Default maximum concurrent task count is 4.
        ...
        /// Image decoding queue. Default maximum concurrent task count is 4.
        ...
        /// Image processing queue. Default maximum concurrent task count is 4.
        ...
        public init(dataLoader: DataLoading = DataLoader(), imageCache: ImageCaching? = ImageCache.shared) {
            ...
            self.dataLoadingQueue.maxConcurrentOperationCount = 8
            self.dataCachingQueue.maxConcurrentOperationCount = 4
            self.imageDecodingQueue.maxConcurrentOperationCount = 4
            self.imageProcessingQueue.maxConcurrentOperationCount = 4
        }
    }
