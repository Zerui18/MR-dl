...
//    var backgroundCompletionHandler: (()->Void)?
    ...
    lazy private var _progress = Progress(totalUnitCount: 999, parent: chapter.serie!.downloader.progress, pendingUnitCount: 1)
    ...
    func initializeVariablesIfNecessary() {
        ...
        guard _progress.totalUnitCount == 999 else {
            return
        }
    ...
    private func startNextPendingTaskIfNecessary()-> Bool {
        guard !downloadsQueue.isEmpty else {
            return false
        }
